...
(function () {
  ...
  const DICTIONARY = {
    "en": {
        ...
        "stage2_desc": "Phases 4 to 6: Fluid camera motion, high-converting commercial ads (Nike, BMW, Claymation), and node automation in <10 mins.",
        ...
        "p5_desc": "Build commercial video ads that generate client income: UGC product review ads, stop-motion Claymation spots, and premium cinematic TVCs (Nike, BMW style).",
        "p5_b1": "High-converting UGC avatar product review templates",
        "p5_b2": "Claymation stop-motion & stylized brand commercial spots",
        "p5_b3": "Nike & BMW cinematic TVC deconstruction & shotlists",
    ...
    "vi": {
        ...
        "stage2_desc": "Phase 4 đến Phase 6: Chuyển động máy quay mượt mà, dựng TVC thương hiệu (Nike, BMW, Claymation) và làm ads dưới 10 phút.",
        ...
        "p5_desc": "Sản xuất video quảng cáo thương mại bán cho nhãn hàng: Video UGC review sản phẩm, hoạt hình đất sét Claymation và TVC thương hiệu phong cách đỉnh cao (Nike, BMW).",
        ...
        "p5_b3": "Giải mã phân cảnh & prompt dựng TVC thể thao và xe hơi BMW",
